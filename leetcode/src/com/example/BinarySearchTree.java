...
public class BinarySearchTree {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("bfsLevelOrderasAnArray [ " + bfsLevelOrderasAnArray(binarySearchTree.root) + " ]");
  ...
  // Space = O(N/2)  = O(N) dropping as 2 is constant= Basically, the total nmo of nodes in your binary tree divide by 2 will give you the leaf nodes if it is a complete binary tree
  // and those leaf nodes size will be the space complexity of this code as our queue shall hold at any given time the total no of nodes ata given level.
