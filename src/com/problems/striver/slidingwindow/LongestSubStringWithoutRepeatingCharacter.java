...
//        System.out.println(longestSubStringWithoutRepeatingCharacter("cadbzabcd"));
    ...
    public static int longestSubStringWithoutRepeatingCharacter(String str) {
        ...
        int len = 0;
        while (r < arr.length) {
            if (hashing.containsKey(arr[r]) && hashing.get(arr[r]) >= l) {
                //hashing.get(arr[r]) > l coz ek element jo pehle mil chuka he usko left pointer ke bd he
                // substring mein count karna cahiye
